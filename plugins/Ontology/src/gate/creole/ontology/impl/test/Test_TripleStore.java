...
public class Test_TripleStore {
  ...
  Closure DIRECT_CLOSURE = Closure.DIRECT_CLOSURE;
  Closure TRANSITIVE_CLOSURE = Closure.TRANSITIVE_CLOSURE;
  ...
  public void testTripleStoreTest1() throws ResourceInstantiationException, MalformedURLException {
    ...
    String rdf_type = OConstants.RDF.TYPE;
    String owl_class = OConstants.OWL.CLASS;
