...
public class AnalysisEnginePR extends AbstractLanguageAnalyser {
      ...
      if(fsBuilder instanceof UIMAAnnotationBuilder) {
        ...
        if(annotsToMap != null) {
          ...
          while(annotsToMapIt.hasNext()) {
            Annotation gateAnnot = (Annotation)annotsToMapIt.next();
            try {
   ...
   * index entry.
   */
  private Annotation getGATEAnnotationFromIndex(
  ...
  private void processMappingDescriptor(Document doc,
