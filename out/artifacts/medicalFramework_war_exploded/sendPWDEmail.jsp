...
<div class="container">
  <%
    session.setAttribute("type","pwd");
  %>
  <form class="form-activate" action="sendEmail.jsp" method="post">
    <h2 class="form-activate-heading">Retrieve your password</h2>
  ...
  <%
    ...
    if(msg!=null){
      if(msg.equals("true")){
        ...
        out.println("The password reset Email has already been sent, please check your Email box");
      }else{
        session.removeAttribute("msg");
